...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.measurementSelectLayout.addLayout(self.formLayout, 15, 0, 1, 1)
        self.label_10 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_10.setObjectName("label_10")
        self.measurementSelectLayout.addWidget(self.label_10, 9, 0, 1, 1)
        self.label_14 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_14.setObjectName("label_14")
        self.measurementSelectLayout.addWidget(self.label_14, 12, 0, 1, 1)
        ...
        self.smoothingType.addItem("")
        self.smoothingType.addItem("")
        self.measurementSelectLayout.addWidget(self.smoothingType, 12, 1, 1, 1)
        ...
        self.graphTabs.setGeometry(QtCore.QRect(600, 10, 1631, 1101))
        ...
        self.measuredMagnitudeGraph = MplWidget(self.magnitudeTab)
        self.measuredMagnitudeGraph.setGeometry(QtCore.QRect(0, 0, 1621, 1061))
        ...
        self.measuredPolarGraph = MplWidget(self.polarTab)
        self.measuredPolarGraph.setGeometry(QtCore.QRect(0, 0, 1621, 1061))
        self.measuredPolarGraph.setObjectName("measuredPolarGraph")
        self.graphTabs.addTab(self.polarTab, "")
        self.tab_2 = QtWidgets.QWidget()
        self.tab_2.setObjectName("tab_2")
        self.modalMagnitudeGraph = MplWidget(self.tab_2)
        self.modalMagnitudeGraph.setGeometry(QtCore.QRect(0, 0, 1621, 1061))
        self.modalMagnitudeGraph.setObjectName("modalMagnitudeGraph")
        self.graphTabs.addTab(self.tab_2, "")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.modalPolarGraph = MplWidget(self.tab)
        self.modalPolarGraph.setGeometry(QtCore.QRect(0, 0, 1621, 1061))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.graphTabs.setTabText(self.graphTabs.indexOf(self.magnitudeTab), _translate("MainWindow", "Measured - Magnitude"))
        self.graphTabs.setTabText(self.graphTabs.indexOf(self.polarTab), _translate("MainWindow", "Measured - Polar"))
        self.graphTabs.setTabText(self.graphTabs.indexOf(self.tab_2), _translate("MainWindow", "Modal - Magnitude"))
        self.graphTabs.setTabText(self.graphTabs.indexOf(self.tab), _translate("MainWindow", "Modal - Polar"))
