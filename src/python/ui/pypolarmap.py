...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.normaliseCheckBox = QtWidgets.QCheckBox(self.gridLayoutWidget)
        self.normaliseCheckBox.setObjectName("normaliseCheckBox")
        self.formLayout_4.setWidget(16, QtWidgets.QFormLayout.FieldRole, self.normaliseCheckBox)
        self.label_15 = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label_15.setObjectName("label_15")
        self.formLayout_4.setWidget(17, QtWidgets.QFormLayout.LabelRole, self.label_15)
        self.normalisationAngle = QtWidgets.QComboBox(self.gridLayoutWidget)
        self.normalisationAngle.setObjectName("normalisationAngle")
        self.normalisationAngle.addItem("")
        self.formLayout_4.setWidget(17, QtWidgets.QFormLayout.FieldRole, self.normalisationAngle)
