...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.showWindowedButton = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.showWindowedButton.setObjectName("showWindowedButton")
        self.chartControls.addWidget(self.showWindowedButton)
        self.showMagnitudeButton = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.showMagnitudeButton.setObjectName("showMagnitudeButton")
        self.chartControls.addWidget(self.showMagnitudeButton)
        self.showUnwindowedButton = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.showUnwindowedButton.setObjectName("showUnwindowedButton")
        self.chartControls.addWidget(self.showUnwindowedButton)
        self.zoomButton = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.zoomButton.setObjectName("zoomButton")
        self.chartControls.addWidget(self.zoomButton)
        ...
        self.showWindowedButton.clicked.connect(MainWindow.showWindowed)
        self.showUnwindowedButton.clicked.connect(MainWindow.showUnwindowed)
        self.showMagnitudeButton.clicked.connect(MainWindow.showMagnitude)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.showWindowedButton.setText(_translate("MainWindow", "Show Windowed"))
        self.showMagnitudeButton.setText(_translate("MainWindow", "Show FR"))
        self.showUnwindowedButton.setText(_translate("MainWindow", "Show Unwindowed"))
